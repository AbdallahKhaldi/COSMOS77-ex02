...
Targets HW2 (exercise number = 2, ex02 repo URL). Field values come from the
...
--template <docx> --output ~/COSMOS77/HW2/COSMOS77-ex02.pdf --exercise-number 2``.
"""
...
_REPO_URL = "https://github.com/AbdallahKhaldi/COSMOS77-ex02"
_STUDENTS = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--exercise-number", type=int, default=2)
